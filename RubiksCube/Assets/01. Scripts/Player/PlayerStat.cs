...
{
    [SerializeField] List<StatData> statDatas = new List<StatData>();
    ...
    public void ModifyStat(StatFlags statType, float degree) => statDictionary[statType].ModifyStat(degree);
    public void SetStat(StatFlags statType, float value) => statDictionary[statType].SetStat(value);
}
